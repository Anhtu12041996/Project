...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="index.html"><svg class="glyph stroked home"><use xlink:href="#stroked-home"/></svg> Trang chủ</a></li>
			<li class="parent ">
				<a href="#">
				...
				<ul class="children collapse" id="sub-item-1" style="height: 0px;">
					<li>
						<a class="" href="#">
			...
			<li><a href="charts.html"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>
 Loại sản phẩm</a></li>
			<li><a href="charts.html"><svg class="glyph stroked landscape"><use xlink:href="#stroked-landscape"/></svg>
			 Slide</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
